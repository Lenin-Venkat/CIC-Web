...
namespace CICLatest.Controllers
{
    ...
    public class ViewForm8Controller : Controller
    {
        ...
        public ViewForm8Controller(IMemoryCache memoryCache, AzureStorageConfiguration azureConfig, ApplicationContext context, UserManager<UserModel> userManager)
        {
            _context = context;
