...
namespace CICLatest.Controllers
{
    public class CertificateForm4Controller : Controller
    {
        ...
        public CertificateForm4Controller(IMemoryCache memoryCache, EmailConfiguration emailconfig, ApplicationContext context, AzureStorageConfiguration azureConfig, IHostingEnvironment _environment)
        {
